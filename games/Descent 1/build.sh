...
# --------------------------------------
scons sdl2=1 sdlmixer=1 d1x=1 lto=0 -j$(nproc) || error "Failed to compile Descent 1 game engine!"
...
Path=/opt/d1x-rebirth
Exec=/opt/d1x-rebirth/d1x-rebirth -nocursor -nomouse -lowmem -hogdir /opt/d1x-rebirth
