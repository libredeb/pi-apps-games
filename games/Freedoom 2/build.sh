...
GAME_DIR="$INSTALL_ROOT/share/freedoom2"
...
install -Dm 644 freedoom/wads/freedoom2.wad "$GAME_DIR/freedoom2.wad"
...
install -Dm 755 pkg/freedoom2 "$GAME_DIR/freedoom2"

# Documentation
install -Dm 644 freedoom/CREDITS freedoom/CREDITS-MUSIC \
    freedoom/NEWS.html freedoom/README.html \
    -t "$INSTALL_ROOT/share/doc/freedoom2"
gzip -nf "$INSTALL_ROOT/share/doc/freedoom2/CREDITS"
gzip -nf "$INSTALL_ROOT/share/doc/freedoom2/CREDITS-MUSIC"
install -Dm 644 freedoom/manual/freedoom-manual-en.pdf \
    ...
    -t "$INSTALL_ROOT/share/doc/freedoom2"
gzip -nf "$INSTALL_ROOT/share/doc/freedoom2/freedoom-manual-"*.pdf

install -Dm 644 freedoom/debian/copyright "$INSTALL_ROOT/share/doc/freedoom2/copyright"

# Custom launcher and icon
tee "$INSTALL_ROOT/share/applications/freedoom2.desktop" <<'EOF'
[Desktop Entry]
Type=Application
Name=Freedoom 2
Comment=Battle monsters in a 32-level campaign
Exec=/usr/share/freedoom2/freedoom2
Icon=freedoom2
Terminal=false
...
StartupNotify=false
EOF
cp pkg/icon.png "$INSTALL_ROOT/share/icons/hicolor/scalable/apps/freedoom2.png"
